...
def WishMe():
    ...
    speak("I am AV!. How may I help you?")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input in ["quit", "exit", "bye", "goodbye"]:
            ...
            speak("I am AV, your personal assistant. I can help you with your queries.")
            continue
            ...
            speak("I am AV, your personal assistant.")
            continue
            ...
            os.system("start brave https://web.whatsapp.com")
            continue
